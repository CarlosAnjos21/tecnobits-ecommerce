...
const ProductListingPage = () => {
  ...
  const categoriasDesejadas = [
    'SMARTPHONE', 'NOTEBOOK', 'HEADPHONE', 'TABLET', 'SMART-TV', 'GADGET', 'PROCESSOR',
    'PLACA GRÁFICA', 'PLACA-MÃE', 'MEMÓRIA RAM', 'ARMAZENAMENTO', 'FONTE DE ENERGIA',
    'RESFRIAMENTO', 'GABINETE', 'MOBILE-PC', 'CONSOLE PORTÁTIL'
  ];
  ...
  const marcasDesejadas = [
    'Apple', 'Samsung', 'Dell', 'Sony', 'LG', 'Nintendo', 'Xiaomi', 'Google', 'Lenovo', 'ASUS',
    'Bose', 'JBL', 'Microsoft', 'Intel', 'AMD', 'NVIDIA', 'MSI', 'GIGABYTE', 'ASRock', 'Corsair',
    'G.Skill', 'Kingston', 'Western Digital', 'Seagate', 'Seasonic', 'EVGA', 'Cooler Master',
    'Thermaltake', 'Noctua', 'NZXT', 'be quiet!', 'Fractal Design', 'OnePlus', 'Nothing',
    'Motorola', 'Huawei', 'Realme', 'Vivo', 'Honor', 'OPPO', 'Framework', 'GPD', 'Valve', 'AYA',
    'OneXPlayer', 'Anbernic', 'MINISFORUM', 'Beelink', 'TCL', 'Hisense', 'Philips',
    'Audio-Technica', 'SteelSeries', 'Sennheiser'
  ];
